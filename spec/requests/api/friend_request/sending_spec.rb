...
RSpec.describe '/api/friend_requests/sending' do
  describe 'GET /api/friend_requests/sending' do
    describe '200系' do
      ...
      before do
        ...
        allow_to_receive_mocked_run(SendingFriendRequestsQuery)
          .and_return([friend_request1, friend_request2])
      end

      it '200' do
        get '/api/sending_friend_requests'
